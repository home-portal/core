...
module.exports = {
	...
	settings: {
		rest: "/calendar-google/",

		tokenFile: "./data/calendar-google/token.json",
		secretFile: "./data/calendar-google/credentials.json",
	...
	methods: {
		...
		async authorize(credentials) {
			...
			const redirectUrl = redirect_uris[0]; // `http://localhost:${this.config.httpPort}/api/calendar-google/oauth-callback`;
